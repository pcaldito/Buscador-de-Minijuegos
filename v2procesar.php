...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="v2-css/v2css.css">
    </head>
    <body>
                    ...
                    if (!empty($minijuegos)) {
                        ...
                        if ($result) {
                            while ($mostrar = mysqli_fetch_assoc($result)) {
                                echo "<p>Nombre del juego: <br><a href='v2datos.php?URLJuego=" . $mostrar['URLJuego'] . "' target='_blank'>" . $mostrar['nombreJuego'] . "</a> | " . $mostrar['nombreAmbito'] . "</p>";
                                echo "<hr>";
                            }
                        } else {
